...
class DroneController(Node):
    ...
    def __init__(self):
        ...
        self.local_orientation_sub = self.create_subscription(VehicleAttitude, '/uav_1/fmu/out/vehicle_attitude',self.local_orientation_callback, qos_profile=qos_profile)
