...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'nested_aruco = drone_testing.nested_aruco:main',
            'mission_course = drone_testing.mission_fsm:main_course',
            'mission_thermal = drone_testing.mission_fsm:main_thermal',
